...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        min_expected_net_edge_pct=float(os.getenv("MIN_EXPECTED_NET_EDGE_PCT", "0.05")),
        min_cost_coverage_multiple=float(os.getenv("MIN_COST_COVERAGE_MULTIPLE", "2.2")),
        max_cost_drag_pct=float(os.getenv("MAX_COST_DRAG_PCT", "0.50")),
        ...
        min_cost_coverage_multiple_balanced=float(os.getenv("MIN_COST_COVERAGE_MULTIPLE_BALANCED", "2.0")),
        ...
        selective_min_cost_coverage_multiple=float(os.getenv("SELECTIVE_MIN_COST_COVERAGE_MULTIPLE", "1.80")),
        paper_exploration_min_cost_coverage=float(os.getenv("PAPER_EXPLORATION_MIN_COST_COVERAGE", "1.10")),
        paper_selective_min_cost_coverage=float(os.getenv("PAPER_SELECTIVE_MIN_COST_COVERAGE", "1.80")),
        paper_exploration_min_rr=float(os.getenv("PAPER_EXPLORATION_MIN_RR", "0.85")),
        paper_selective_min_rr=float(os.getenv("PAPER_SELECTIVE_MIN_RR", "1.20")),
        ...
        brain_min_final_score_exploration=float(os.getenv("BRAIN_MIN_FINAL_SCORE_EXPLORATION", "0.42")),
