...
def run_reconcile_ledger(ledger_reconciler: LedgerReconciler) -> LedgerConsistencyReport:
    ...
    print(f"expected_cash={report.available_cash}")
    print(f"actual_cash={report.actual_available_cash}")
    print(f"reserved_capital_total={report.reserved_capital_total}")
    print(f"notional_open_positions={report.notional_open_positions}")
    print(f"fees_paid_total={report.fees_paid_total}")
    print(f"realized_pnl={report.realized_pnl}")
    print(f"expected_equity={report.total_equity}")
    print(f"actual_equity={report.actual_total_equity}")
    print(f"cash_diff={report.cash_check}")
    print(f"equity_diff={report.equity_check}")
    print(f"available_cash_before_open={report.latest_available_cash_before_open}")
    print(f"available_cash_after_open={report.latest_available_cash_after_open}")
    print(f"reserved_cash_after_open={report.latest_reserved_cash_after_open}")
    print(f"position_notional={report.latest_position_notional}")
    print(f"entry_fees={report.latest_entry_fees}")
    print(f"entry_slippage={report.latest_entry_slippage}")
    print(f"entry_spread={report.latest_entry_spread}")
    print(f"equity_before_open={report.latest_equity_before_open}")
    print(f"equity_after_open={report.latest_equity_after_open}")
    print(f"reconciled_positions={report.reconciled_positions}")
    print(f"reconciled_duplicates={report.reconciled_duplicates}")
    print(f"result={report.result}")
    print(f"ledger_fail_reason={report.ledger_fail_reason or 'none'}")
    print("notes:")
...
def run_status_report(
    ...
    print(f"- expected_cash: {ledger_report['available_cash']}")
    print(f"- actual_cash: {ledger_report['actual_available_cash']}")
    print(f"- reserved_capital_total: {ledger_report['reserved_capital_total']}")
    print(f"- notional_open_positions: {ledger_report['notional_open_positions']}")
    print(f"- fees_paid_total: {ledger_report['fees_paid_total']}")
    print(f"- expected_equity: {ledger_report['total_equity']}")
    print(f"- actual_equity: {ledger_report['actual_total_equity']}")
    print(f"- cash_check: {ledger_report['cash_check']}")
    print(f"- equity_check: {ledger_report['equity_check']}")
    print(f"- available_cash_before_open: {ledger_report['latest_available_cash_before_open']}")
    print(f"- available_cash_after_open: {ledger_report['latest_available_cash_after_open']}")
    print(f"- reserved_cash_after_open: {ledger_report['latest_reserved_cash_after_open']}")
    print(f"- position_notional: {ledger_report['latest_position_notional']}")
    print(f"- entry_fees: {ledger_report['latest_entry_fees']}")
    print(f"- entry_slippage: {ledger_report['latest_entry_slippage']}")
    print(f"- entry_spread: {ledger_report['latest_entry_spread']}")
    print(f"- equity_before_open: {ledger_report['latest_equity_before_open']}")
    print(f"- equity_after_open: {ledger_report['latest_equity_after_open']}")
    print(f"- result: {ledger_report['result']}")
    print(f"- ledger_fail_reason: {ledger_report['ledger_fail_reason'] or 'none'}")
    print("- notes:")
